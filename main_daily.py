...
async def run_daily_unified(
    ...
    # arXiv pipeline uses YYYY-MM-DD date format
    ...
    # ── Step 5: Merge HTML ────────────────────────────────────────────────
    logger.info("Step 5: 合并统一日报...")
    from src.tools.unified_report import build_unified_html

    unified_html = build_unified_html(run_date, arxiv_html, github_html, official_html, blog_html)
    ...
    unified_md = build_unified_md(run_date, arxiv_md, github_md, official_md, blog_md)
