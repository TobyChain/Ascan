...
from src.blog_subs.stages import FetchBlogStage, BuildBlogFragmentStage
...
async def run_daily(date_compact: str) -> PipelineContext:
    ...
    stages = [FetchBlogStage(), BuildBlogFragmentStage()]
    stage_enums = [Stage.FETCHING, Stage.GENERATING]
